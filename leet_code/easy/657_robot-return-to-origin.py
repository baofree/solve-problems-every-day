...
on a 2D plane. Given a sequence of its moves, judge if this robot ends up at (0, 0) after it completes its moves.
...
engineer-kr. Also, assume that the magnitude of the robot's movement is the same for each move.
