...
class Solution:
    def removeElement(self, nums, val):
        ...
        :rtype: int
        """
        first_val_index = None
        for i in range(len(nums)):
            if first_val_index is None and nums[i] == val:
                first_val_index = i
            elif nums[i] != val and first_val_index is not None:
...
if __name__ == '__main__':
    ...
    # print(solution.removeElement1([0, 1, 2, 2, 3, 0, 4, 2], 2))
